...
export default {
  ...
  methods: {
    ...
    Init() {
      ...
      this.requireJsonData("../../../public/case/province_pm.json");
      this.requireJsonData("../../../public/case/polyline.json");
      this.requireJsonData("../../../public/case/label.json");
      this.requireJsonData("../../../public/case/plate_border.json");
