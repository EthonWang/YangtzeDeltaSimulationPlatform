<template>
  <el-row class="row">
    <el-col :span="13">
      <div style="height:55px;background-color: #ffffff;border: 1px solid #DCDCDC;">
        <p style="margin-left: 15px;margin-top: 12px;font-size: 26px;font-weight: bold; letter-spacing:3px;">
          长三角科学创新的空间格局仪表盘（ACM论文库）</p>
      </div>
    </el-col>
    <el-col :span="10" :offset="1">
      <div style="height:55px;margin-left:-20px;background-color: #ffffff;border: 1px solid #DCDCDC;">
  ...
  <el-row class="row">
    <el-col :span="4">
      <div style="height:525px;background-color: #ffffff;border: 1px solid #DCDCDC;">
        <p class="blockTitle">创新领域信息概览</p>
        <div id="treemap" style="margin-top:-28px;width:100%;height: 100%;margin-left: 10px">
          <el-image :src=imagePath></el-image>
        </div>
      </div>
    </el-col>
    <el-col :span="8" :offset="1">
      <div style="margin-top:0px;height:525px;background-color: #ffffff;border: 1px solid #DCDCDC;">
        <p class="blockTitle"><span id="area-2" v-if="radioArea == 'YRD'">{{area}}</span><span id="area-2" v-else>{{area}}在长三角区域</span>内部合作形态</p>
        <div id='map1' style="margin-top:0px;margin-left:1.5%;width: 97%;height: 485px"></div>
      </div>
    </el-col>
    <el-col :span="10" :offset="1">
      <div style="height:290px;background-color: #ffffff;border: 1px solid #DCDCDC;">
        <p class="blockTitle"><span id="area-3">{{area}}</span>与国内其它地区（不含港澳台）合作形态</p>
        <div id='map2' style="margin-top:0px;margin-left:1.5%;width: 97%;height: 250px"></div>
      </div>
      <div style="height:225px;background-color: #ffffff;border: 1px solid #DCDCDC;">
        <p class="blockTitle"><span id="area-4">{{area}}</span>与国际及港澳台地区合作形态</p>
        <div id='map3' style="margin-top:0px;margin-left:1.5%;width: 97%;height: 185px"></div>
      </div>
    </el-col>
  </el-row>
</template>
