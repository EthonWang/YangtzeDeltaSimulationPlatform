  ...
  <div class="rainForecast-back">
    ...
    <div class="flex-row-center" style="height: 75px">
      ...
      <dv-decoration-11 style="width: 400px; height: 75px; color: #fafafa"
        ><h1>长三角降雨预报专题</h1></dv-decoration-11
      >
      <dv-decoration-3 style="width: 250px; height: 40px" />
    </div>
    ...
    <div class="content-container flex-row-evenly">
      ...
      <div class="content-col-2 flex-Column-Around-Center">
        ...
        <dv-border-box-1
          :color="['#00a1ff']"
          style="width: 100%; height: 35%; position: relative"
        >
...
export default {
  ...
  methods: {
    ...
    changeRainDay() {
      ...
      let imgUrl =
        "/case/rainForecast/temp_rain_imgs/2008-08-06-" +
        this.dayCount +
        ".png";
    ...
    createHistoryRiverLevelChart() {
      if (
        historyRiverLevelChart != null &&
        historyRiverLevelChart != "" &&
        historyRiverLevelChart != undefined
      ) {
        historyRiverLevelChart.dispose(); //销毁
      }
      historyRiverLevelChart = echarts.init(
        document.getElementById("historyRiverLevelChart"),
        "dark"
      );
      let option;
