<template>
    <div id="app">
        ...
        <div class="background">
            <el-image style="width: 100%;height: 100%" :src="backgroundUrl_cr"></el-image>
        </div>
        <!-- 案例标题
        ...
        <!--故事线-->
        <div class="layer" style="height:5%;width:90%;margin-left:5%;margin-top: 1%;box-shadow: 0 2px 4px rgba(0, 0, 0, .4), 0 0 6px rgba(0, 0, 0, .4);">
        ...
        <div class="layer" style="height:82%;width:90%;margin-left:5%;margin-top: 1%;box-shadow: 0 2px 4px rgba(0, 0, 0, .4), 0 0 6px rgba(0, 0, 0, .4); overflow:auto">
            <router-view></router-view>
        </div>
        <div class="layer" style="height: 5%;width: 90%;margin-left: 5%;padding-top: 20px;">
            <el-button v-if="StepActive!==3" style="float: right" type="success" plain @click="next">下一步</el-button>
            <el-button v-if="StepActive!==0" style="float: right; margin-right: 2%"  type="primary" plain @click="prev">上一步</el-button>
        </div>
    </div>
  </template>
