  ...
  (newval, oldval) => {
    if (newval) {
      setTimeout(() => {
        ...
        document.getElementsByClassName("container")[0].style.background =
          "transparent";
        document.getElementsByClassName("bg_pro")[0].style.opacity = "1";
      }, 200);
    } else {
      setTimeout(() => {
...
.randMove() {
  ...
  // animation: floating calc((abs(@randomNum / 2) + 20) * 1s) ease-in-out infinite alternate;
  @keyframes floating {
    0% {
