        ...
        <el-col class="data-show-map-wrapper">
            <div id="data-show-map">
                <div class="leaflet-control map-select">
                    ...
                    <!--  弹出对话框-->
                    <el-dialog :title=excel.name v-model="dialogTableVisible" width="60%">
        ...
        methods:{
            ...
            getExcel(){
                ...
                for(let i = 0 ; i<this.MongoDBData.length ; i++){
                    if(this.tableName == this.MongoDBData[i].name && this.MongoDBData[i].region.includes(this.city)){
            ...
            controlDialog() {
                ...
                for (let keyname in this.excel.data[0]) {
                    if (Object.prototype.hasOwnProperty.call(this.excel.data[0], keyname)) {
                        if (keyname.indexOf("index") === -1 && keyname.indexOf("得分") === -1 && keyname.indexOf("权重") === -1) {
            ...
            radioClickMap(){
                ...
                console.log(Global.VisualJson,this.MapIndex,'Global.VisualJson和this.MapIndex');
            ...
            getMongoDBData(){
                ...
                for(let i = 0 ; i<this.MongoDBDataOb.length ; i++){
                    if(this.MongoDBDataOb[i].scale == this.GeoJsonGroup && this.MongoDBDataOb[i].data.length > 1 ){
...
<style scoped>    .data-show-map-wrapper {
    display: flex;
    align-items: center;
