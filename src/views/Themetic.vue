  ...
  <div class="about">
          ...
          <div>
            ...
            <div class="dataBlock">
              ...
              <el-button
                ...
                plain
              ></el-button>
              <el-dialog v-model="newCasesVisible" title="新增案例" width="35%">
                ...
                <el-row class="editDialogRow"
                  ...
                  ><el-col :span="20" :offset="1"
                    ><el-input
                      v-model="editingCases.description"
                      placeholder="请输入案例描述"
                    ></el-input></el-col
                ></el-row>
                <el-row class="editDialogRow"
                ...
                <el-row class="editDialogRow">
                  <el-button
                    type="warning"
                    size="default"
                    @click="outCancelCases"
                    >取消</el-button
                  >
                  <el-button
                    type="success"
                    size="default"
                    @click="outSubmitCases"
                    >保存</el-button
                  >
                </el-row>
              </el-dialog>
    ...
    >
      ...
      <el-row class="editDialogRow"
        ><span>问题名称:</span
        ><el-col :span="20" :offset="1"
          ><el-input disabled :placeholder="thematicName"></el-input></el-col
      ></el-row>
      <el-row class="editDialogRow"
        ><span>问题简介:</span
        ><el-col :span="20" :offset="1"
        ...
        <template v-for="(item, key) in relatedCases" :key="key">
          <el-card :body-style="{ padding: '0px' }" style="margin-left: 10px">
            ...
            >
              ...
              <div style="">
                <el-button size="small" @click="handleEditCases(item, key)"
                  >编辑</el-button
                >
                <el-button size="small" @click="deleteCases(key)"
                  >删除</el-button
                >
              </div>
            </div>
      ...
      <el-row style="justify-content: center; margin-bottom: 10px"
        ><el-button :icon="Plus" size="large" @click="newCases" plain
          >添加专题相关案例</el-button
        ></el-row
      >
      <el-row
        v-show="editOrNew == 'new' || editOrNew == 'edit'"
        ...
        <el-card style="width: 100%; margin-right: 10px">
          ...
          <el-row class="editDialogRow">
            <template v-if="editOrNew == 'new'">
              <el-button type="warning" size="default" @click="cancelEdit"
                >取消</el-button
              >
              <el-button type="success" size="default" @click="submitNewCases"
                >保存</el-button
              >
            </template>
            <template v-else>
              <el-button type="warning" size="default" @click="cancelEdit"
                >取消</el-button
              >
              <el-button type="success" size="default" @click="saveEditCases"
                >保存</el-button
              >
            </template>
          </el-row>
