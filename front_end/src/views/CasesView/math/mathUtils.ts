...
// function setQuaternionFromProperEuler( q: Vector4, a: number, b: number, c: number, order: string ) {
...
function denormalize( value: number, array: Float32Array | Uint16Array | Uint8Array | Int16Array | Int8Array ) {
...
function normalize( value: number, array: Float32Array | Uint16Array | Uint8Array | Int16Array | Int8Array ) {
