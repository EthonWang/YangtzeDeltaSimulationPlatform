<template>
    <div style="height: 100%;width: 100%;">
        <div class="background">
            <el-image style="width: 100%;height: 100%"  :src="backgroundUrl" ></el-image>
        </div>
        <div style="height: 100%;width: 100%">
            ...
            <el-main style="height: 80%;width: 100%">
                <el-col style="height:100%;width: 40%;padding-left: 120px;padding-top: 40px">
...
<!--                    <el-row style="height: 12%;width: 100%;padding-top: 20px" :gutter="20" type="flex">-->
<!--                        <el-col :offset="1" >-->
<!--                            <el-button style="height: 90%" type="primary">-->
<!--                                <router-link  to="/SdgPlatform/Home" class="ButtonTitle">-->
<!--                                    开始探索-->
<!--                                </router-link>-->
<!--                            </el-button>-->
<!--                        </el-col>-->
<!--                    </el-row>-->
                ...
                <el-col  style="height: 100%;width: 50%;padding-left:200px">
                    <div class="hero-browser" >
                        <div class="bubble-3 is-revealing">
                            <svg width="300" height="186" viewBox="0 0 427 286" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <defs>
            ...
            <el-footer style="height: 10%;width: 100%">
