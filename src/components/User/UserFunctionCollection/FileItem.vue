<template>
  ...
  >
    ...
    <img
      ...
      v-else-if="
        file.name.split('.')[1] == 'zip' || file.name.split('.')[1] == 'rar'
      "
      style="width: 80%"
    />
    <img
    ...
    <img
      ...
      v-else-if="
        file.name.split('.')[1] == 'ppt' || file.name.split('.')[1] == 'pptx'
      "
      style="width: 80%"
    />
    <img
      ...
      v-else-if="file.name.split('.')[1] == 'xlsx'"
      style="width: 80%"
    />
    <img
    ...
    <img
      ...
      v-else-if="file.name.split('.')[1] == 'txt'"
      style="width: 80%"
    />
