    ...
    >
      <el-col :span="8">
        <div class="box-left left1">
          <dv-border-box1>
            <dv-decoration-7 class="box-title"
              ><h3 class="box-title-text">创新投入</h3></dv-decoration-7
            >
        ...
        <div class="box-left left2">
          <dv-border-box1>
            <dv-decoration-7 class="box-title"
              ><h3 class="box-title-text">创新环境</h3></dv-decoration-7
            >
            <div id="leftChart2" class="chart"></div> </dv-border-box1
          >dv-decoration-7
        </div>
        <div class="box-left left3">
          <dv-border-box1>
            <dv-decoration-7 class="box-title"
              ><h3 class="box-title-text">创新产出</h3></dv-decoration-7
            >
      ...
      <el-col :span="8">
        ...
        <div class="box-mid mid3">
          <dv-border-box1>
            ...
            <div
              id="midChart1"
              style="height: 75%; width: 95%; padding: 0 15px 0 15px"
            ></div>
          </dv-border-box1>
        </div>
        <div class="box-mid mid4">
          <dv-border-box1>
            <div style="width: 100%; height: 30px; display: flex">
              <dv-decoration-7
                style="
                  margin-left: calc(calc(100% - 360px) / 2);
                  width: 180px;
                  height: 30px;
                "
                ><h3>瞪羚企业数</h3></dv-decoration-7
              >
              <dv-decoration-7
                style="
      ...
      <el-col :span="8">
        <div class="box-right right1">
          <dv-border-box1>
            <dv-decoration-7 class="box-title"
              ><h3 class="box-title-text">重点城市创新概况</h3></dv-decoration-7
            >
        ...
        <div class="box-right right2">
          <dv-border-box1>
            <dv-decoration-7 class="box-title"
              ><h3 class="box-title-text">创新综合评价结果</h3></dv-decoration-7
            >
    ...
    series: [
      {
        name: "专利申请数",
        type: "bar",
        data: [173586, 593878, 435805, 167039],
        markPoint: {
          data: [
            { type: "max", name: "Max" },
            { type: "min", name: "Min" },
      ...
      },
      {
        name: "专利授权数",
        type: "bar",
        data: [100587, 314153, 285320, 82524],
        markPoint: {
          data: [
            { type: "max", name: "Max" },
            { type: "min", name: "Min" },
  ...
  option = {
    ...
    series: [
      ...
      },
      {
        ...
        data: [27.1223, 12.94, 9.2898, 8.6032],
      },
      {
        name: "高被引科学家数(人)",
        type: "bar",
