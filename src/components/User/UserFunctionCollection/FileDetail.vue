<template>
  <div class="about">
    <div class="file-detail">
      ...
      <span class="tag" v-for="tag in props.file.tags" :key="tag">{{
        tag
      }}</span
      ><br /><br />
      <el-switch
      ...
      ><br />
      <span>数据格式：{{ props.file.type }}</span
      ><br />
      ...
      ><br />
      <el-button style="margin-top: 2%; width: 100%" type="primary"
        ><el-icon><Download /></el-icon>&nbsp;下载数据</el-button
      ><br />
      <el-button style="margin-top: 2%; width: 100%" type="danger"
        ><el-icon><Delete /></el-icon>&nbsp;删除数据</el-button
      >
      <el-button text @click="dialogVisible1 = !dialogVisible1"
        >关系图谱</el-button
      >
    </div>
    <el-dialog v-model="dialogFormVisible" title="数据描述">
      <el-form :model="form">
...
const form = reactive(props.file);
const dialogFormVisible = ref(false);
const dialogVisible1 = ref(false);
const formLabelWidth = "140px";

const value1 = computed(() => {
  return props.file.isPublic;
});
