...
var CanvasFlowmapLayer = L.GeoJSON.extend({
    ...
    initialize: function (geoJson, options) {
        ...
        if (window.hasOwnProperty.call('TWEEN')) {
    ...
    setAnimationEasing: function (easingFamily, easingType) {
        ...
        if (
            TWEEN.Easing.hasOwnProperty.call(easingFamily) &&
            TWEEN.Easing[easingFamily].hasOwnProperty.call(easingType)
        ) {
    ...
    _drawSelectedCanvasPaths: function (animate) {
        ...
        // console.log(this.originAndDestinationGeoJsonPoints)
        this.originAndDestinationGeoJsonPoints.features.forEach(function (feature) {
            ...
            if (feature.properties._isSelectedForPathDisplay) {
                ...
                var weight = feature.properties[originAndDestinationFieldIds.weight]
                ...
                var symbol;
                this.options.canvasBezierStyle.symbol.lineWidth = weight;
                if (animate) {
